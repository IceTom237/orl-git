...
{
	public static var orlVersion:String = '2.0.0';
	...
	var optionShit:Array<String> = ['story_mode', 'freeplay', 'options', 'extras', 'credits'];
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "One Ring Left v" + orlVersion, 12);
